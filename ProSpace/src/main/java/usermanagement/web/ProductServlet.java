...
public class ProductServlet extends HttpServlet {
	...
	response.sendRedirect("product-list.jsp"); // и перенаправляемся на страницу списка пользователей
	}
	...
	RequestDispatcher dispatcher = request.getRequestDispatcher("product/product-form.jsp");//здесь будем редактировать наш пользовательский объект
