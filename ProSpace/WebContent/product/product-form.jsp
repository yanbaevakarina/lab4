...
<style type="text/css">
   ...
   a:link {
	...
	<header><br>
				<a href="<%=request.getContextPath()%>/product/product-list.jsp" class="headerer"><h4>Товары</h4></a>
				<c:if test="${product != null}"><form action="/product/update" method="post">
				</c:if>
				<c:if test="${product == null}"><form action="/product/insert" method="post">
				</c:if>
